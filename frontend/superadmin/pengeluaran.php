...
<div class="container py-5">
    <h2 class="mb-4">Data Pengeluaran</h2>
        ...
        <table class="table table-bordered table-striped align-middle">
            ...
            ?>
                <tr class="text-center">
                    ...
                    <td>
                        <a href="edit_pengeluaran.php?id=<?= $r['id_pengeluaran'] ?>" class="btn btn-sm btn-warning mb-1">Edit</a>
                        <a href="../../backend/pengeluaran/index.php?action=delete&id=<?= $r['id_pengeluaran'] ?>" 
